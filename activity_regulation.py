...
class ActivityRegulator:
    ...
    def run_sync(self):
        """Synchronous wrapper method to run the activity regulator from a thread
        ...
        self._log_activity('cognitive', "Starting activity regulation loop")
        try:
            ...
            self._log_activity('emergency', f"Activity regulation thread error: {str(e)}")
